  ...
  const scopesHTML = frm.doc.scopes
    ? frm.doc.scopes
        .map((scope, index) => {
          ...
          const totalAmount = scopeItems.reduce(
            (sum, item) => sum + (item.overall_price || 0),
            0
          );
          const itemCount = scopeItems.length;

          return `
            <div class="scope-item clickable" data-scope-number="${
              scope.scope_number
            }" style="background-color: ${colorSet.bg}; color: ${
            colorSet.text
          }">
                <div class="scope-number" style="background-color: ${
                  colorSet.text
                }; color: ${colorSet.bg}">
                    ${scope.scope_number}
                </div>
...
<div class="project-header">
    ...
    <div class="project-details">
        <div class="project-meta">
            ...
            <div class="status-chip status-${(frm.doc.status || "")
              .toLowerCase()
              .replace(" ", "-")}">
                ${frm.doc.status || ""}
            </div>
        ...
        <div class="party-tags">
            ${(frm.doc.parties || [])
              .map(
                (party) => `
                <div class="party-tag ${party.type.toLowerCase()}" data-party="${encodeURIComponent(
                  party.party
                )}">
                    <i class="fa fa-${
                      party.type === "Client"
    ...
    <div class="project-overview">
        ...
        <div class="overview-card net">
            ...
            <div class="amount">${formatCurrency(
              (frm.doc.due_receivables || 0) - (frm.doc.due_payables || 0)
            )}</div>
                      ...
                      (frm.doc.proformas || []).length
                        ? (frm.doc.proformas || [])
                            ...
                            <div class="doc-list-item">
                                ...
                                ">${row.scope || ""}</div>
                                <div class="doc-info">
                                    <a href="/app/project-bill/${
                                      row.bill
                                    }" class="bill">${row.bill}</a>
                                    <div class="amount">${formatCurrency(
                                      row.grand_total
                                    )}</div>
                                </div>
                        ...
                        ? (frm.doc.received_table || [])
                            ...
                            <div class="payment-list-item">
                                ...
                                <div class="payment-info">
                                    <a href="/app/payment-voucher/${
                                      row.voucher
                                    }" class="voucher">${row.voucher}</a>
                                    <div class="amount">${formatCurrency(
                                      row.amount
                                    )}</div>
                                </div>
    ...
    <div class="finance-section additional-expenses">
        <div class="section-header">
            ...
            <span class="total-badge">Total: ${formatCurrency(
              frm.doc.total_additional_expenses || 0
            )}</span>
        </div>
                        ...
                        <div class="section-container">
                            ...
                            <div class="parameters-grid">
                                ...
                                <div class="scope-detail-card">
                                    ...
                                    <div class="detail-value ${
                                      scope.vat_inclusive ? "highlighted" : ""
                                    }">${
          scope.vat_inclusive ? "Yes" : "No"
        }</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="summary-grid" style="
                        ...
                        <div class="summary-card" style="
                            ...
                            <div class="card-value" style="
                                ...
                                font-weight: 600;">${formatCurrency(
                                  projectTotals.totalPriceExclVAT
                                )}</div>
                        </div>
                        ...
                        <div class="summary-card highlighted" style="
                            ...
                            <div class="card-value" style="
                                font-size: 1.3rem;
                                font-weight: 600;
                                color: var(--text-color);">${formatCurrency(
                                  projectTotals.totalPriceInclVAT
                                )}</div>
                        </div>
                        ...
                        <div class="summary-card" style="
                            ...
                            <div class="card-value" style="
                                font-size: 1.2rem;
                                font-weight: 600;
                                color: var(--text-on-red);">${formatCurrency(
                        ...
                        <div class="summary-card" style="
                            ...
                            <div class="card-value" style="
                                font-size: 1.2rem;
                                font-weight: 600;
                                color: var(--green-600);">${formatCurrency(
                                  projectTotals.totalProfit
                                )}</div>
                        </div>
                    </div>
                </div>
                ...
                ${scopeChips
                  .map((scope, index) => {
                    ...
                    const colorSet = isAll
                      ...
                      : SCOPE_COLORS[
                          (parseInt(scope) - 1) % SCOPE_COLORS.length
                        ];
                    ...
                    return `
                        <div class="scope-chip ${isActive ? "active" : ""}" 
                             ...
                             style="background: ${colorSet.bg}; 
                                    color: ${colorSet.text};
                                    border: 2px solid ${
                                      isActive ? colorSet.text : "transparent"
                                    };
                                    box-shadow: ${
                                      isActive
                                        ? `0 2px 6px ${colorSet.bg}`
                                        : "none"
                                    };
                                    transform: ${
